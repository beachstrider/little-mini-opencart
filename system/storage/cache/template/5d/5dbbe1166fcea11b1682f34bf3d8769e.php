...
class __TwigTemplate_2b82eec4d31b03985f7a85312640e1e0 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<div class=\"sm:mt-[24px] mt-[18px] text-center sm:text-[16px] text-[12px]\">
    ...
    {
        return new Source("", "catalog/view/template/common/section_know_more.twig", "/home/xttl3xy3mfcj/public_html/catalog/view/template/common/section_know_more.twig");
    }
}
