...
class __TwigTemplate_025537dea040b25ef0a1fab92e178bce extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<div class=\"sm:mt-[38px] mt-[23px] text-center sm:text-[16px] text-[12px]\">
    ...
    {
        return new Source("", "catalog/view/template/common/section_how_possible.twig", "E:\\xampp\\htdocs\\catalog\\view\\template\\common\\section_how_possible.twig");
    }
}
